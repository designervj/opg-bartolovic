    ...
    <div className="w-full bg-white text-neutral-900 font-sans-custom selection:bg-amber-200 selection:text-neutral-900">
      ...
      <section className="relative w-full h-[280px] sm:h-[340px] md:h-[400px] overflow-hidden flex items-center justify-center">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1587049352851-8d4e89133924?auto=format&fit=crop&w=1920&q=85')`,
          }}
        >
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto space-y-3 sm:space-y-4">
          ...
          <p className="font-sans-custom text-white/95 text-xs sm:text-sm md:text-base leading-relaxed max-w-2xl mx-auto font-normal">
        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <h2 className="font-mono-custom font-bold text-2xl sm:text-3xl lg:text-[34px] text-neutral-900 leading-tight tracking-tight">
                OPG Bartolović – s<br className="hidden sm:inline" /> ljubavlju iz Valpova
              </h2>

              <div className="space-y-4 text-xs sm:text-[13.5px] leading-relaxed text-neutral-700">
                <p>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="inline-flex items-center justify-center bg-neutral-900 hover:bg-neutral-800 text-white font-mono-custom text-xs uppercase tracking-wider px-6 py-3 rounded-xs transition-colors cursor-pointer"
                >
      ...
      <section className="py-16 sm:py-20 bg-[#F7F5F0]">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <h3 className="font-sans-custom font-bold text-base sm:text-lg text-neutral-900 leading-snug">
              ...
              <ul className="space-y-3.5">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-3">
                    ...
                    <span className="text-xs sm:text-[14px] text-neutral-800">
                      {item}
                    </span>
                  </li>
                ))}
              ...
              <p className="text-xs sm:text-[13.5px] leading-relaxed text-neutral-600 pt-2">
      ...
      <section className="py-20 sm:py-28 bg-white">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-3 mb-16">
            <h2 className="font-mono-custom font-bold text-2xl sm:text-3xl text-neutral-900 tracking-tight">
              Naš tim
            </h2>
            <p className="font-sans-custom text-xs sm:text-[13.5px] text-neutral-700 leading-relaxed">
              Naš tim je mala, ali snažna obiteljska zajednica koja dijeli zajedničku strast prema pčelarstvu i očuvanju prirode.
            </p>
            <p className="font-sans-custom text-xs sm:text-[13.5px] text-neutral-500">
              Tko smo mi:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="space-y-1">
                <h3 className="font-mono-custom font-bold text-sm sm:text-base text-neutral-900">
                  Ivo Bartolović
                </h3>
          ...
          <div className="mt-16 text-center max-w-2xl mx-auto">
            <p className="font-sans-custom text-xs sm:text-[13.5px] text-neutral-600 leading-relaxed">
