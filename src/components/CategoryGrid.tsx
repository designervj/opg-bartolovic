  ...
  return (
    <section className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 mb-5 sm:gap-y-6">
        ...
        >
          <img
            src="/assets/images/honey_acacia_category_1790164604186.jpg"
            alt="Med od bagrema"
          ...
          <div className="absolute bottom-6 left-6 sm:bottom-7 sm:left-7 z-10">
            <h3 className="font-mono-custom font-bold text-xl sm:text-2xl lg:text-[26px] text-white tracking-tight drop-shadow-md">
              Med od bagrema
            </h3>
          </div>
        </div>
        ...
        >
          <img
            src="/assets/images/honey_linden_category_1790164615791.jpg"
            alt="Med od lipe"
            referrerPolicy="no-referrer"
            className="w-full h-full object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
        ...
        >
          <img
            src="/assets/images/honey_flower_category_1790164628395.jpg"
            alt="Cvijetni med"
            referrerPolicy="no-referrer"
            className="w-full h-full object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105"
          />
          ...
          <div className="absolute bottom-5 left-5 sm:bottom-6 sm:left-6 z-10">
            <h3 className="font-mono-custom font-bold text-lg sm:text-xl lg:text-[22px] text-white tracking-tight drop-shadow-md">
              Cvijetni med
            </h3>
          </div>
        </div>
        ...
        >
          <img
            src="/assets/images/honey_meadow_category_1790164640833.jpg"
            alt="Livadni med"
            referrerPolicy="no-referrer"
            className="w-full h-full object-cover object-center transition-transform duration-700 ease-out group-hover:scale-105"
          />
        ...
        >
          <img
            src="/assets/images/honey_comb_category_1790164653021.jpg"
